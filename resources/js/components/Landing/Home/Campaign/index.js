    ...
    return (
        <Box py={5}>
            <Container maxWidth="xl">
                <Typography variant="h2" color="primary" pb={5} mb={2} align="center"
                            className={classes.title}>Campaign</Typography>
                                ...
                                <Grid container>
                                    <Grid item lg={8}>
                                        ...
                                        <Typography variant='h6' margin={2}>
                                            ...
                                            vivamus sollicitudin interdum morbi sed varius vestibulum et, lectus.
                                            Vel porta eget ac est nam. Hendrerit id amet euismod et facilisis
                                            tincidunt nibh.
                                            Lorem ipsum dolor sit amet, consectetur ta eget ac est nam. Hendrerit id
                                            amet euismod et facilisis tincidunt nibh.
                                        </Typography>

                                        <Typography margin={2}>
                                            <AccessTimeIcon/> 10.00am - 3.00pm | <RoomOutlinedIcon/> Dhaka,
                                            Bangladesh
                                        </Typography>
